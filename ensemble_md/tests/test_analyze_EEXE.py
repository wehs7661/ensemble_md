...
def test_parse_transmtx():
    ...
    A1_expected = np.array([[0.5035941, 0.27816516, 0.15014392, 0.06404528, 0.01056806, 0.00325544],
        [0.27816516, 0.1430219, 0.22873016, 0.12587893, 0.0782651, 0.07551135],  # noqa: E128
        [0.15014392, 0.22873016, 0.12687601, 0.22781774, 0.19645289, 0.14166102],
        [0.06404528, 0.12587893, 0.22781774, 0.0986531, 0.27133784, 0.18215007],
        [0.01056806, 0.0782651, 0.19645289, 0.27133784, 0.06328789, 0.36931726],
        [0.00325544, 0.07551135, 0.14166102, 0.18215007, 0.36931726, 0.2982755]])

    B1_expected = np.array([[0.5, 0.34782609, 0.15000001, 0, 0, 0],
        [0.34782609, 0.18181819, 0.15789473, 0.17647059, 0.10526316, 0.125],  # noqa: E128
        [0.15000001, 0.15789473, 0, 0.14285715, 0.4375, 0.07692308],
        [0, 0.17647059, 0.14285715, 0.16666667, 0.2857143, 0.18181819],
        [0, 0.10526316, 0.4375, 0.2857143, 0, 0.23076923],
        [0, 0.125, 0.07692308, 0.18181819, 0.23076923, 0.2]])

    C1_expected = np.array([[3.5941000e-03, -6.9660930e-02, 1.4391000e-04, 6.4045280e-02, 1.0568060e-02, 3.2554400e-03],  # noqa: E501
        [-6.9660930e-02, -3.8796290e-02, 7.0835430e-02, -5.0591660e-02, -2.6998060e-02, -4.9488650e-02],  # noqa: E128
