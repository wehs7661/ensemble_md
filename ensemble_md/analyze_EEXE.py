...
class TransitionMatrix:
    """
    This class provides methods for obtaining and visualizing the data of transition matrices from EEXE.
    """
    def __init__(self):
        pass 
    ...
    def state_transmtx(self):
        pass

    def replica_transmtx(self):
        pass 
    ...
    def plot_matrix(self, matrix, png_name, title=None, start_idx=0):
        ...
        ax = sns.heatmap(matrix, cmap="YlGnBu", linecolor='silver', linewidth=0.25,
                        annot=annot_matrix, square=True, mask=matrix < 0.005, fmt='.2f', 
                        cbar=False, xticklabels=x_tick_labels, yticklabels=y_tick_labels)
        ax.xaxis.tick_top()
